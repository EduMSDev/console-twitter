...
public class FollowCommand extends Command {
    ...
    @Override
    public void execute() {
        System.out.printf("%s  enter the name of the user you want to follow: ",
        ...
        boolean userAdded =
                twitterReceiver.getUsers().stream().anyMatch(user -> user.getName().equalsIgnoreCase(namePerson));
